...
2.01 or higher).  GD allows you to create color drawings using a large
number of graphics primitives, and emit the drawings as PNG files.

%description -l pl
GD.pm jest perlowym interfejsem do biblioteki graficznej gd Thomasa
Boutella (w wersji 2.0.1 lub wy¿szej).  GD pozwala na tworzenie kolorowych
rysunków przy u¿yciu du¿ej liczby graficznych prymitywów, oraz zapisywanie
ich w formacie PNG.
...
# %{__make} test partially fails - probably reference pictures were
#   generated by gd 1.8.x, which didn't have truecolor/alpha support
